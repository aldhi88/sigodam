                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center my-5">
                            <h1 class="font-weight-bold text-error">4 <span class="error-text">0<img src="{{ asset('assets/images/error-img.png') }}" alt="" class="error-img"></span> 3</h1>
                            <h3 class="text-uppercase">Maaf, anda tidak ada hak akses terhadap halaman ini.</h3>
